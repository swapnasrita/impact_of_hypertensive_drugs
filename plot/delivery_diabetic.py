...
female_normal_file = './SGLT2_Female_hum_Severe_diab' #SS
#female_normal_file = './Female_hum_Y_diab' #Uncomment
# female_nhe50_file = './female_nhe50_check'
# female_nhe80_file = './female_nhe80_check'
male_normal_file = './SGLT2_Male_hum_Severe_diab'  #SS
#male_normal_file = './Female_hum_normal' #Uncomment
...
male_delivery_jux5 = []
for seg in segment_early:
    #SS-changed the filename from female_hum_.. --> male_hum_..
...
#ax.set_xlabel('Segment',fontsize=20)
axarr[3,1].set_ylim(0,100)#SS added a y limit
...
#plt.show()
plt.savefig('delivery_diabetic.png',bbox_inches='tight')
